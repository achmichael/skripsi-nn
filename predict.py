...
from src.utils.core import NeuralNetwork


MODEL_PATHS = {
    "prabayar": "model_prabayar.json",
    "pascabayar": "model_pascabayar.json",
}
...
def main():
    ...
    model, metadata = NeuralNetwork.load(MODEL_PATHS[model_type])
    ...
    for i in range(input_size):
        feature_name = feature_columns[i] if i < len(feature_columns) else f"x{i + 1}"
