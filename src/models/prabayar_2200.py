"""
Prabayar Model for 2200VA Capacity
Specialized neural network for predicting token duration for 2200VA electrical capacity.
"""
...
class Prabayar2200Model(PrabayarModel):
    """
    Neural Network Model optimized for 2200VA capacity households.
    
    This model is trained specifically on 2200VA capacity data (141 samples).
    Architectural considerations:
    - Non-subsidy category
    - Larger households with many appliances (AC, washing machine, etc.)
    ...
    def __init__(
        ...
        self.capacity = "2200VA"
    
    def save(self, path: str, metadata: dict | None = None) -> None:
        """Save model with capacity identifier."""
        data: dict = {
            "model_class": "Prabayar2200Model",
            "capacity": "2200VA",
    ...
    @classmethod
    def load(cls, path: str) -> tuple["Prabayar2200Model", dict]:
        """Load 2200VA specific model."""
    ...
    def get_summary(self) -> str:
        ...
        return (
            f"Prabayar2200Model (2200VA Capacity) | Arsitektur: {self.layer_sizes} | "
