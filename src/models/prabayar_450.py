"""
Prabayar Model for 450VA Capacity
Specialized neural network for predicting token duration for 450VA electrical capacity.
"""
...
class Prabayar450Model(PrabayarModel):
    """
    Neural Network Model optimized for 450VA capacity households.
    
    This model is trained specifically on 450VA capacity data (80 samples).
    Architectural considerations:
    - Smaller network to prevent overfitting on limited data
    - Optimized for subsidy households (450VA typically subsidized)
    - Focuses on basic household appliance patterns
    """
    ...
    @classmethod
    def load(cls, path: str) -> tuple["Prabayar450Model", dict]:
        """Load 450VA specific model."""
    ...
    def get_summary(self) -> str:
        ...
        return (
            f"Prabayar450Model (450VA Capacity) | Arsitektur: {self.layer_sizes} | "
