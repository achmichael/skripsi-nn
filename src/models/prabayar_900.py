"""
Prabayar Model for 900VA Capacity
Specialized neural network for predicting token duration for 900VA electrical capacity.
"""
...
class Prabayar900Model(PrabayarModel):
    """
    Neural Network Model optimized for 900VA capacity households.
    
    This model is trained specifically on 900VA capacity data (259 samples).
    Architectural considerations:
    - Optimized for subsidy vs non-subsidy distinction
    - Focuses on typical household appliance patterns for this capacity
    - Largest dataset enables more complex architecture
    """
    ...
    @classmethod
    def load(cls, path: str) -> tuple["Prabayar900Model", dict]:
        """Load 900VA specific model."""
    ...
    def get_summary(self) -> str:
        ...
        return (
            f"Prabayar900Model (900VA Capacity) | Arsitektur: {self.layer_sizes} | "
